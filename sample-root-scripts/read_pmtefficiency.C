...
void read_pmtefficiency(const char* filename = "../rootfile/wcsim_output.root")
{
    ...
    TH1F *chargePerHitHist = new TH1F("Charge per Hit", "Charge per Hit Distribution", 100, 0, 4);
    TH1F *totalChargePerHitHist = new TH1F("Total Charge per Hit", "Total Charge per Hit Distribution", 100, 0, 2);
