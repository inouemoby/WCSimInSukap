...
void WCSim_read(const HitListManager &manager = HitListManager())
{
...
void make_gui()
{
  ...
  DigitQ = kTRUE;
  {
    ...
    TGTextButton *QTButton;
    if (DigitQ)
    {
      QTButton = new TGTextButton(QT, "Displayed Color Change");
    }
    else
    {
      QTButton = new TGTextButton(QT, "Displayed Color Change");
...
void Display3DView(const HitListManager &manager = HitListManager())
{
  /*
  char* wcsimdirenv;
