...
void show_pmtorienabove60(const char* filename = "../rootfile/wcsim_output.root")
{
  //define parameter
  //int startID = 1;
/*
...
*/
    ...
    //TLorentzVector photonPosition(0, 250, 0, 0);
    //TLorentzVector photonPosition(0, -300, 0, 0);  
    //TLorentzVector photonPosition(150, 0, 0, 0);
    TLorentzVector photonPosition(0, 370, 0, 0);
	...
	for (int tubeID = 1; tubeID <= numPMTs; ++tubeID)
	{
    	...
    	manager.ReplaceBelowThreshold(60);
